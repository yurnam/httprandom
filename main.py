...
def catch_all(path):
    ...
    if response_type == "json":
        ...
        prompt = (
            ...
            f"generate sarcastic content using those keywords {random_words.get_random_words()}\n"
            ...
            "include a lot of content and stories based on the endpoint the user requested\n"
            ...
            f"include links to these pages: {random_words.get_random_links()}"
            "=== REQUEST DATA (JSON) ===\n"
            f"{request_dump}\n"
            "=== END REQUEST DATA ===\n"
        )
